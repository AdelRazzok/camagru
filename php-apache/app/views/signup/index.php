    ...
    <div class="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
        ...
        <form action="/signup" method="post" class="flex flex-col space-y-4">
            <div class="flex flex-col">
                ...
                <input type="email" name="email" placeholder="john.doe@example.com" class="border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-sky-500" required>
            </div>
