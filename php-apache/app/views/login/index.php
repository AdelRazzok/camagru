    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        ...
        <form action="#" method="post" class="flex flex-col space-y-4">
            ...
            <div class="flex flex-col">
                ...
                <input type="password" name="password" placeholder="**********" class="border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-sky-500" required>
            </div>
